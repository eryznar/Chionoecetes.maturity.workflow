...
tab <- data.frame(
  ...
  `Proposed workflow` = c(
    ...
    "Robust to spatiotemporal gaps and variability in maturity through random fields; uncertainty is also tied to sample sizes via Bernoulli structure and propagated across all workflow steps",
